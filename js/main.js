...
function adminlogin() {
    ...
    var m = document.getElementById("ff");
...
function gotoid() {
    window.location = "userid.php";
}

function gotoinvest() {
    window.location = "investadmin.php";
}

function gotowithdrawal() {
    window.location = "withdrawadmin.php";
}
